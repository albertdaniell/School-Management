...
if (mysqli_query($conn, $sql5)) {
    ...
    echo "<br> Error creating table: " . mysqli_error($conn);
            ...
            $sql6="CREATE TABLE fees(
                ...
                $sql7="CREATE TABLE fee_structure(
                    ...
                    $sql8="CREATE TABLE setting2(
                        ...
                        if (mysqli_query($conn, $sql8)) {
                            echo " <br >Table setting2 created successfully <br>";
                        } else {
                            echo "<br> Error creating table: " . mysqli_error($conn);
                        }
            
                        $check_setting2 = mysqli_query($conn, "SELECT *FROM `setting2`");
                        if(mysqli_num_rows($check_setting2)>0){
                            echo " <br> Only one record is allowed in settings2";
                           
                        }
            
                       else{
                        $add_setting2=mysqli_query($conn,"INSERT INTO `setting2` VALUES('Term','Term 1')");
                        if($add_setting2){
                            echo "<br> Setting2 for term created";
