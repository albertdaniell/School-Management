...
>>>>>>> 4849f855cb9b15285c0197e5566bbccb2baac8b8
                        ...
                        <h3><i class="fa fa-graduation-cap"></i> All Students (<?php echo $students_nums ?>) <button class="btn btn-default" onclick="all_students()">Reload</button> </h3>
                        <hr>

                        <div class="col-sm-12" id="sort-ctrl">
                            <form action="" class="horizontal" id="sort-student-form">
                                <div class="form-group">
                                    <div class="col-sm-3">
