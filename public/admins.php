...
<<<<<<< HEAD
                              ...
                              <?php
                              $school_name=mysqli_query($conn,"SELECT *FROM `setting2` WHERE title='Term'");
                              while($row=mysqli_fetch_array($school_name)){
                                  $term=$row[1];
                              ...
                              if($email == 'albertagoya@gmail.com'){
                                echo '  <button class="btn btn-default" term="'.$term.'" id="change-term-btn">Change current term </button>
                              ';  
                              }

                              else{
                                  echo "Only super user can edit the current term";
                              }
