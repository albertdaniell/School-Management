                            ...
                            <div class="col-sm-12">
                                ...
                                <div id="collapse2">
                                    ...
                                    <div id="collapse-content2">
                                      <div id="all-fee-payments">
                                      
                                      <?php
$fetch_fee=mysqli_query($conn,"SELECT *FROM fees INNER JOIN student ON fees.student_reg = student.id  ORDER BY fees.date_updated DESC LIMIT 0,10");
...
while($row=mysqli_fetch_array($fetch_fee)){
    ...
    <tr>
    <td><a href='../urls/view_student.php?sreg=$sreg'>$student_name</a></td>
    <td>$class</td>
    <td>$term</td>
    <td>$fee</td>
    <td>$receipt_no</td>
