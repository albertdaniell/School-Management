...
$("body").delegate("#change-term-btn", "click", function (e) {
    ...
    $.ajax({
        url:"../urls/change_term_action.php",
        method:"GET",
        data:{
            term:term,
...
$("body").delegate("#update-term-form", "submit", function (e) {
    e.preventDefault();
    
    var original = $(this).attr('term');
    
    var term = document.getElementById("term").value;
 
    
    $.ajax({
        url:"../urls/change-term.php",
        method:"GET",
        data:{
            term:term,
            original:original,
...
$("body").delegate("#add-to-feestructure-form", "submit", function (e) {
    e.preventDefault();
    ...
    $.ajax({
        url:"../urls/add-to-feestructure.php",
        method:"POST",
        data:{
            term:term,
            year:year,
